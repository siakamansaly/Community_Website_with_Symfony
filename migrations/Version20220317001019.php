 ...
 */
final class Version20220317001019 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media CHANGE name name LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE type type VARCHAR(10) NOT NULL COLLATE `utf8mb4_unicode_ci`');
